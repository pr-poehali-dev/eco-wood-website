      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-eco-600 text-lg max-w-3xl mx-auto">
            Мы — семейная компания, которая производит и продаёт качественный пиломатериал прямо от производителя, без посредников и скрытых наценок.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-eco-700 leading-relaxed">
              <p>
                Николай Николаевич Машков основал небольшое деревообрабатывающее предприятие 
