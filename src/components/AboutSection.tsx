export default function AboutSection() {
  ...
  const team = [
    { name: 'Александр Дворников', role: 'Основатель и директор', exp: '20 лет в лесной промышленности' },
    { name: 'Марина Соколова', role: 'Главный технолог', exp: 'Контроль качества продукции' },
    { name: 'Дмитрий Лесной', role: 'Менеджер по продажам', exp: 'Ваш личный консультант' },
  ];
    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="section-title mb-4">ЭкоДрев — с 2009 года</h2>
          <p className="text-eco-600 text-lg max-w-3xl mx-auto">
            Мы — семейная компания с пятнадцатилетней историей. Начинали как небольшая пилорама 
            в Вологодской области, сегодня — один из крупнейших поставщиков пиломатериалов в регионе.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-eco-700 leading-relaxed">
              <p>
                В 2009 году Александр Дворников основал небольшое деревообрабатывающее предприятие 
                в сердце вологодских лесов. Идея была проста: предоставлять людям качественную 
                древесину по честной цене, прямо от производителя.
              </p>
              <p>
                За 15 лет мы выросли в полноценный деревообрабатывающий комплекс с современным 
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              {[
                ...
                { value: '500+', label: 'видов продукции' },
